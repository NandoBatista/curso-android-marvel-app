package com.batista.core.data.network.interceptor
...
class AuthorizationInterceptor(
    ...
    //Interceptando as requisições e adicionando a chave de API automaticamente
    @Suppress("MagicNumber")
    override fun intercept(chain: Interceptor.Chain): Response {
        val request = chain.request()
        val requestUrl = request.url

        //Gerando nossa nova URL com base na atual
